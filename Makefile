...
export REGISTRY = juno1nc5tatafv6eyq7llkr2gv50ff9e22mnf70qgjlv737ktmt4eswrq68ev2p
...
registry-subscribe:
	./scripts/registry/registry-subscribe.sh $(from) $(callbacl_url) $(industry_code) $(operate_type) $(nkn) $(location) 
